...
<meta name="description" content="Design Gráfico & Web">
...
<div class="container-fluid bg01">
  <div class="container">
    ...
    <header class="row-fluid" > 
      <!---->
      <div class="nav-lateral"  data-spy="affix"> 
        <nav class="span2 pull-left"> <span class="span12"> <img src="img/joelgouveia.png" alt="Logotipo Joel Gouveia" title="Joel Gouveia" class="logo" /> </span>
          <div>
