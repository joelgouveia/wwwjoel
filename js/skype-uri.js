...
var Skype = new function () {
    ...
    // Deprecated: Check if the analyze method for uri init is loaded, run if it is
    function tryAnalyzeSkypeUriInit() {
        ...
        if (typeof this.analyzeSkypeUriInit == 'function') {
            ...
            var _t = {};
            _t.prop1 = actionType + " Init (pre script load)";
            _t.prop4 = document.domain + " - Init";
            _t.prop5 = "image size / color: " + this.imageSize + " / " + this.imageColor;
            _t.prop6 = "video / list participants / list topic: " + this.video + " / " + this.listParticipants + " / " + this.listTopic;
            _t.prop7 = "target(s): " + this.participants;
            _t.prop8 = "user agent: " + navigator.userAgent;
            _t.prop9 = "detected platform: " + this.detectedPlatform;
            _t.prop10 = "detected browser: " + this.detectedBrowser;
            this.analyzePreCrumbs.push(_t);
        }
    }

    // Deprecated: Check if the analyze method for call action is loaded, run if it is
    function tryAnalyzeSkypeUriAction() {
        ...
        if (typeof this.analyzeSkypeUriAction == 'function') {
            ...
            if (this.name == "chat") actionType = "Chat";
            var _t = {};
            _t.prop1 = actionType + " Action (pre script load)";

            if (this.name == "chat") {
                _t.prop2 = document.domain + " - Chat";
            } else {
                _t.prop3 = document.domain + " - Call";
            }
    ...
    // Deprecated: Check if the analyze method for uri redirection is loaded, run if it is
    function tryAnalyzeSkypeUriRedirect() {
        ...
        if (typeof this.analyzeSkypeUriRedirect == 'function') {
            ...
            var _t = {};
            _t.prop1 = "Redirect (pre script load)";
            _t.prop5 = "image size / color: " + this.imageSize + " / " + this.imageColor;
            _t.prop6 = "video / list participants / list topic: " + this.video + " / " + this.listParticipants + " / " + this.listTopic;
            _t.prop7 = "target(s): " + this.participants;
            _t.prop8 = "user agent: " + navigator.userAgent;
    ...
    function tryAnalyzeSkypeUri(analyzeType, crumbIndex) {
        ...
        if (typeof this.analyzeSkypeUri == 'function') {
            ...
            if (analyzeType == "init") {
                _t.prop1 = actionType + " Init";
                _t.prop4 = document.domain + " - Init";
            }
            else if (analyzeType == "action") {
                _t.prop1 = actionType + " Action";
                if (this.name == "chat") {
                    _t.prop2 = document.domain + " - Chat";
                } else {
                    _t.prop3 = document.domain + " - Call";
    ...
    function ui(skypeUri) {
        ...
        _tPostScript.prop5 = "image size / color: " + this.imageSize + " / " + this.imageColor;
        _tPostScript.prop6 = "video / list participants / list topic: " + this.video + " / " + this.listParticipants + " / " + this.listTopic;
        _tPostScript.prop7 = "target(s): " + this.participants;
        _tPostScript.prop8 = "user agent: " + navigator.userAgent;
        _tPostScript.prop9 = "detected platform: " + this.detectedPlatform;
        _tPostScript.prop10 = "detected browser: " + this.detectedBrowser;
        ...
        if (!this.useDetection || (!this.isWinPhone8 && this.isIE10) || this.isIE7 || this.isIE6) {
            ...
            uriAnchor.setAttribute("onclick", "Skype.tryAnalyzeSkypeUri('action', '" + this.analyzeCrumbIndex + "');");
        ...
        // no detection and display not-supported msg
            ...
            uriAnchor.setAttribute("onclick", "Skype.tryAnalyzeSkypeUri('action', '" + this.analyzeCrumbIndex + "'); Skype.displayNotSupportedMsg();");
        ...
        // using detection
            ...
            uriAnchor.setAttribute("href", "javascript://");
            uriAnchor.setAttribute("onclick", "Skype.tryAnalyzeSkypeUri('action', '" + this.analyzeCrumbIndex + "');" + (tStr + "('" + uriStr + "', '" + this.detectSkypeClientFrameId + "', '" + this.analyzeCrumbIndex + "'); return false;"));
        }
        ...
        uriImage.setAttribute("src", "img/skype.png");
        uriImage.setAttribute("alt", uriLinkImage);
        uriImage.setAttribute("style", ("border:0; margin:" + 5 + "px; vertical-align:" + this.assetSizeMap[("size" + this.assetSize)].verticalOffset + "px"));
